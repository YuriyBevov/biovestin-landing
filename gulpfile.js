...
const html = () => {
  return src(PATHS.html.src)
    ...
    .pipe(gulpif(isHtmlMin, dest(PATHS.html.dest)))
...
const pug = () => {
  return src([PATHS.pug.src])
    ...
    .pipe(gulpif(isHtmlMin, dest(PATHS.pug.dest)));
};
...
const resources = () => {
  return src(PATHS.resources.src).pipe(dest(PATHS.resources.dest));
};
...
const toWebp = () => {
  return src(PATHS.images.src).pipe(webp()).pipe(dest(PATHS.images.dest));
};
...
const server = () => {
  ...
  isPugEnabled
    ...
    : watch(PATHS.html.watchSrc, series(html, refresh));
